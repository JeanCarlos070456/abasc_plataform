    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'supabase_user_id',
                    models.UUIDField(blank=True, null=True, unique=True, verbose_name='ID Supabase'),
                ),
                (
                    'role',
                    models.CharField(
                ...
                (
                    ...
                    models.CharField(
                        ...
                        null=True,
                        unique=True,
                        verbose_name='número de associado',
                    ),
                ),
                (
                    'association_status',
                    models.CharField(
                        ...
                        default='pending',
                        max_length=20,
                        verbose_name='situação associativa',
                    ),
                ),
                ...
                (
                    ...
                    models.DateField(blank=True, null=True, verbose_name='data de associação'),
                ),
